...
if ( have_posts() ) :
	...
	while ( have_posts() ) : the_post();
		...
		if (get_post()->post_type != 'post') {
			...
			<div class="post-cover wow animated fadeIn">
						...
						<div class="row">
							...
							<div class="col-xs-12 col-md-5">
								...
								<h1 class="post-title wow animated fadeIn" data-wow-delay="0.2s"><?php the_title() ?></h1>
									<div class="post-excerpt wow animated fadeInRight" data-wow-duration="0.9s" data-wow-delay="-0.35s"><?php the_field('excerpt') ?></div>
